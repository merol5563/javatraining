...
public class RelationalOperators {
    ...
    public static void main(String[] args) {
        ...
        boolean isEligibleForLoan = creditscore >= 720;// if the credit score is 720 or greader,then it's eligible for the loan
        ...
        int score = 50;
        boolean hasfaild = score <=59;
         //                  75 <=59

        System.out.println("hasfaid = " + hasfaild);
